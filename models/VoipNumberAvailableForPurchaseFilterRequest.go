...
type VoipNumberAvailableForPurchaseFilterRequest struct {
	...
	PendingToBeConfigured_EQ           bool           `bson:"pendingToBeConfigured_EQ" json:"pendingToBeConfigured_EQ"`
	RecordIncomingCalls_EQ             bool           `bson:"recordIncomingCalls_EQ" json:"recordIncomingCalls_EQ"`
	RequiresCustomerInfo_EQ            bool           `bson:"requiresCustomerInfo_EQ" json:"requiresCustomerInfo_EQ"`
...
func BuildVoipNumberAvailableForPurchaseFilterRequest(m map[string]interface{}, x *VoipNumberAvailableForPurchaseFilterRequest) {
	...
	if val, ok := m["pendingToBeConfigured_EQ"]; ok && val != nil {
		x.PendingToBeConfigured_EQ = val.(bool)
	}
	if val, ok := m["recordIncomingCalls_EQ"]; ok && val != nil {
		x.RecordIncomingCalls_EQ = val.(bool)
	}
	if val, ok := m["requiresCustomerInfo_EQ"]; ok && val != nil {
		x.RequiresCustomerInfo_EQ = val.(bool)
	}
