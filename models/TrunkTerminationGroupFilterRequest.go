...
type TrunkTerminationGroupFilterRequest struct {
...
func BuildTrunkTerminationGroupFilterRequest(m map[string]interface{}, x *TrunkTerminationGroupFilterRequest) {
