...
type CallIncomingToExtensionFilterRequest struct {
	...
	Contact_DateCreated_EQ                                          time.Time      `bson:"contact_DateCreated_EQ" json:"contact_DateCreated_EQ"`
	Contact_DateCreated_GTE                                         time.Time      `bson:"contact_DateCreated_GTE" json:"contact_DateCreated_GTE"`
	Contact_DateCreated_LTE                                         time.Time      `bson:"contact_DateCreated_LTE" json:"contact_DateCreated_LTE"`
	Contact_DateUpdated_EQ                                          time.Time      `bson:"contact_DateUpdated_EQ" json:"contact_DateUpdated_EQ"`
	Contact_DateUpdated_GTE                                         time.Time      `bson:"contact_DateUpdated_GTE" json:"contact_DateUpdated_GTE"`
	Contact_DateUpdated_LTE                                         time.Time      `bson:"contact_DateUpdated_LTE" json:"contact_DateUpdated_LTE"`
	...
	DateEnded_EQ                                                    time.Time      `bson:"dateEnded_EQ" json:"dateEnded_EQ"`
	DateEnded_GTE                                                   time.Time      `bson:"dateEnded_GTE" json:"dateEnded_GTE"`
	DateEnded_LTE                                                   time.Time      `bson:"dateEnded_LTE" json:"dateEnded_LTE"`
	...
	ExtensionFriendlyName_CON                                       string         `bson:"extensionFriendlyName_CON" json:"extensionFriendlyName_CON"`
	ExtensionFriendlyName_EQ                                        string         `bson:"extensionFriendlyName_EQ" json:"extensionFriendlyName_EQ"`
	ExtensionFriendlyName_REG                                       string         `bson:"extensionFriendlyName_REG" json:"extensionFriendlyName_REG"`
	ExtensionNumber_CON                                             string         `bson:"extensionNumber_CON" json:"extensionNumber_CON"`
	ExtensionNumber_EQ                                              string         `bson:"extensionNumber_EQ" json:"extensionNumber_EQ"`
	ExtensionNumber_REG                                             string         `bson:"extensionNumber_REG" json:"extensionNumber_REG"`
	...
	FromInternationalFormat_CON                                     string         `bson:"fromInternationalFormat_CON" json:"fromInternationalFormat_CON"`
	FromInternationalFormat_EQ                                      string         `bson:"fromInternationalFormat_EQ" json:"fromInternationalFormat_EQ"`
	FromInternationalFormat_REG                                     string         `bson:"fromInternationalFormat_REG" json:"fromInternationalFormat_REG"`
	...
	IdLineThatAnswered_CON                                          string         `bson:"idLineThatAnswered_CON" json:"idLineThatAnswered_CON"`
	IdLineThatAnswered_EQ                                           string         `bson:"idLineThatAnswered_EQ" json:"idLineThatAnswered_EQ"`
	IdLineThatAnswered_REG                                          string         `bson:"idLineThatAnswered_REG" json:"idLineThatAnswered_REG"`
	IdsLinesThatDidNotRing_CON                                      string         `bson:"idsLinesThatDidNotRing_CON" json:"idsLinesThatDidNotRing_CON"`
	IdsLinesThatDidNotRing_EQ                                       string         `bson:"idsLinesThatDidNotRing_EQ" json:"idsLinesThatDidNotRing_EQ"`
	IdsLinesThatDidNotRing_REG                                      string         `bson:"idsLinesThatDidNotRing_REG" json:"idsLinesThatDidNotRing_REG"`
	IdsLinesThatRing_CON                                            string         `bson:"idsLinesThatRing_CON" json:"idsLinesThatRing_CON"`
	IdsLinesThatRing_EQ                                             string         `bson:"idsLinesThatRing_EQ" json:"idsLinesThatRing_EQ"`
	IdsLinesThatRing_REG                                            string         `bson:"idsLinesThatRing_REG" json:"idsLinesThatRing_REG"`
...
func BuildCallIncomingToExtensionFilterRequest(m map[string]interface{}, x *CallIncomingToExtensionFilterRequest) {
	...
	if val, ok := m["contact_DateCreated_EQ"]; ok && val != nil {
		x.Contact_DateCreated_EQ = val.(time.Time)
	}
	if val, ok := m["contact_DateCreated_GTE"]; ok && val != nil {
		x.Contact_DateCreated_GTE = val.(time.Time)
	}
	if val, ok := m["contact_DateCreated_LTE"]; ok && val != nil {
		x.Contact_DateCreated_LTE = val.(time.Time)
	}
	if val, ok := m["contact_DateUpdated_EQ"]; ok && val != nil {
		x.Contact_DateUpdated_EQ = val.(time.Time)
	}
	if val, ok := m["contact_DateUpdated_GTE"]; ok && val != nil {
		x.Contact_DateUpdated_GTE = val.(time.Time)
	}
	if val, ok := m["contact_DateUpdated_LTE"]; ok && val != nil {
		x.Contact_DateUpdated_LTE = val.(time.Time)
	}
	...
	if val, ok := m["dateEnded_EQ"]; ok && val != nil {
		x.DateEnded_EQ = val.(time.Time)
	}
	if val, ok := m["dateEnded_GTE"]; ok && val != nil {
		x.DateEnded_GTE = val.(time.Time)
	}
	if val, ok := m["dateEnded_LTE"]; ok && val != nil {
		x.DateEnded_LTE = val.(time.Time)
	}
	...
	if val, ok := m["extensionFriendlyName_CON"]; ok && val != nil {
		x.ExtensionFriendlyName_CON = val.(string)
	}
	if val, ok := m["extensionFriendlyName_EQ"]; ok && val != nil {
		x.ExtensionFriendlyName_EQ = val.(string)
	}
	if val, ok := m["extensionFriendlyName_REG"]; ok && val != nil {
		x.ExtensionFriendlyName_REG = val.(string)
	}
	if val, ok := m["extensionNumber_CON"]; ok && val != nil {
		x.ExtensionNumber_CON = val.(string)
	}
	if val, ok := m["extensionNumber_EQ"]; ok && val != nil {
		x.ExtensionNumber_EQ = val.(string)
	}
	if val, ok := m["extensionNumber_REG"]; ok && val != nil {
		x.ExtensionNumber_REG = val.(string)
	}
	...
	if val, ok := m["fromInternationalFormat_CON"]; ok && val != nil {
		x.FromInternationalFormat_CON = val.(string)
	}
	if val, ok := m["fromInternationalFormat_EQ"]; ok && val != nil {
		x.FromInternationalFormat_EQ = val.(string)
	}
	if val, ok := m["fromInternationalFormat_REG"]; ok && val != nil {
		x.FromInternationalFormat_REG = val.(string)
	}
	...
	if val, ok := m["idLineThatAnswered_CON"]; ok && val != nil {
		x.IdLineThatAnswered_CON = val.(string)
	}
	if val, ok := m["idLineThatAnswered_EQ"]; ok && val != nil {
		x.IdLineThatAnswered_EQ = val.(string)
	}
	if val, ok := m["idLineThatAnswered_REG"]; ok && val != nil {
		x.IdLineThatAnswered_REG = val.(string)
	}
	if val, ok := m["idsLinesThatDidNotRing_CON"]; ok && val != nil {
		x.IdsLinesThatDidNotRing_CON = val.(string)
	}
	if val, ok := m["idsLinesThatDidNotRing_EQ"]; ok && val != nil {
		x.IdsLinesThatDidNotRing_EQ = val.(string)
	}
	if val, ok := m["idsLinesThatDidNotRing_REG"]; ok && val != nil {
		x.IdsLinesThatDidNotRing_REG = val.(string)
	}
	if val, ok := m["idsLinesThatRing_CON"]; ok && val != nil {
		x.IdsLinesThatRing_CON = val.(string)
	}
	if val, ok := m["idsLinesThatRing_EQ"]; ok && val != nil {
		x.IdsLinesThatRing_EQ = val.(string)
	}
	if val, ok := m["idsLinesThatRing_REG"]; ok && val != nil {
		x.IdsLinesThatRing_REG = val.(string)
	}
