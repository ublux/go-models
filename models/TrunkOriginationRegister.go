...
func (x TrunkOriginationRegister) GetDateCreated() string {
	return x.DateCreated
}
func (x TrunkOriginationRegister) GetDateDeleted() string {
	return x.DateDeleted
}
func (x TrunkOriginationRegister) GetDateUpdated() string {
