...
func (x VoipNumberAvailableForPurchase) GetDateDeleted() time.Time {
	return x.DateDeleted
}
func (x VoipNumberAvailableForPurchase) GetDateCreated() time.Time {
	return x.DateCreated
}
func (x VoipNumberAvailableForPurchase) GetDateUpdated() time.Time {
