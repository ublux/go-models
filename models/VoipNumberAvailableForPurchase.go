...
func (x VoipNumberAvailableForPurchase) GetDateCreated() string {
	return x.DateCreated
}
func (x VoipNumberAvailableForPurchase) GetDateDeleted() string {
	return x.DateDeleted
}
func (x VoipNumberAvailableForPurchase) GetDateUpdated() string {
