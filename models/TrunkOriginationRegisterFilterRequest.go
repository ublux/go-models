...
type TrunkOriginationRegisterFilterRequest struct {
...
func BuildTrunkOriginationRegisterFilterRequest(m map[string]interface{}, x *TrunkOriginationRegisterFilterRequest) {
