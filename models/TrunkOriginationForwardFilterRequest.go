...
type TrunkOriginationForwardFilterRequest struct {
...
func BuildTrunkOriginationForwardFilterRequest(m map[string]interface{}, x *TrunkOriginationForwardFilterRequest) {
