...
func (x CloudServiceWebApp) GetDateDeleted() time.Time {
	return x.DateDeleted
}
func (x CloudServiceWebApp) GetDateCreated() time.Time {
	return x.DateCreated
}
func (x CloudServiceWebApp) GetDateUpdated() time.Time {
