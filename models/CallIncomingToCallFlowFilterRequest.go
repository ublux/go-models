...
type CallIncomingToCallFlowFilterRequest struct {
...
func BuildCallIncomingToCallFlowFilterRequest(m map[string]interface{}, x *CallIncomingToCallFlowFilterRequest) {
