...
type CallOutgoingToExtensionFilterRequest struct {
...
func BuildCallOutgoingToExtensionFilterRequest(m map[string]interface{}, x *CallOutgoingToExtensionFilterRequest) {
