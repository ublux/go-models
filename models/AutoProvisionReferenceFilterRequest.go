...
type AutoProvisionReferenceFilterRequest struct {
...
func BuildAutoProvisionReferenceFilterRequest(m map[string]interface{}, x *AutoProvisionReferenceFilterRequest) {
