...
type VoipNumberPhoneUpdateRequest struct {
...
func (x VoipNumberPhoneUpdateRequest) GetId() string {
	return x.Id
}

// BUILDER from bson map:
func BuildVoipNumberPhoneUpdateRequest(m map[string]interface{}, x *VoipNumberPhoneUpdateRequest) {
