...
type CloudServiceWebServiceFilterRequest struct {
...
func BuildCloudServiceWebServiceFilterRequest(m map[string]interface{}, x *CloudServiceWebServiceFilterRequest) {
